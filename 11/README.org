...
** Installing and configuring software
   ...
   at XXX to identify what you need to do, and the respective
...
** Getting the lab distribution
   ...
   git repository hosted on the [[http://gitlab.doc.gold.ac.uk][Department's gitlab instance]].  You
   should be able to issue the following command:
#+begin_example
  git clone ...
#+end_example
   and the lab bundle code will be downloaded to the ... directory
